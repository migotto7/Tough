...
const moveCardBackward = () => {
  ...
  setFirstCardAsDisabled();
}

function moveCardForward() {
  const lastChild = productCards.lastElementChild;
  const secondLastChild = lastChild.previousElementSibling;

  productCards.insertBefore(secondLastChild, productCards.firstElementChild.nextSibling);
